...
const ProjectPage = () => {
  const projects = [
    ...
    },
    {
      ...
      demoLink: 'https://shopping-checkout-react-q7hgawa5c-joenetuban-gmailcoms-projects.vercel.app/',
    ...
    },
    {
      ...
      demoLink: 'https://fitness-client-peg7-lg7aexegm-joenetuban-gmailcoms-projects.vercel.app',
            ...
            <div className="project-card">
              ...
              <div className="project-info p-3">
                ...
                <div className="project-buttons">
                  ...
                  <a href={project.codeLink} className="btn btn-secondary" target="_blank" rel="noopener noreferrer">Code</a>
                </div>
              </div>
            </div>
          </div>
